<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="架子编号" prop="name">
        <el-input
    ...
    <el-table v-loading="loading" :data="rackList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:rack:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:rack:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
function getList() {
  loading.value = true;
  listRack(queryParams.value).then(response => {
...
function handleExport() {
  proxy.download('system/rack/export', {
    ...queryParams.value
