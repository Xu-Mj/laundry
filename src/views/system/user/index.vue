      ...
      <el-row :gutter="20">
         ...
         <el-col :span="20" :xs="24">
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
               ...
               <el-table-column label="用户等级" align="center" key="postName" prop="postName" v-if="columns[7].visible" />
               <el-table-column label="用户类型" align="center" prop="userType" v-if="columns[8].visible">
                  <template #default="scope">
                     <dict-tag :options="sys_user_type" :value="scope.row.userType" />
                  </template>
               </el-table-column>
               <el-table-column label="用户组织" align="center" key="deptName" prop="dept.deptName"
               ...
               <el-col :span="12">
                  <el-form-item label="归属组织" prop="deptId">
                     <el-tree-select v-model="form.deptId" :data="deptOptions"
                        ...
                        placeholder="请选择归属组织" check-strictly />
                  </el-form-item>
               </el-col>
            </el-row>
            <el-row>
...
const columns = ref([
   ...
   { key: 1, label: `用户账号`, visible: false },
   ...
   { key: 8, label: `用户等级`, visible: true },
   { key: 9, label: `备注信息`, visible: false },
