...
const manageMenus = [
  ...
  { 'name': '字典管理', 'type': 'primary', show: false, path: '/system/dict', onClick: () => router.push('/system/dict') },
  { 'name': '衣物品类', 'type': 'primary', show: true, path: '/system/clothingCategory', onClick: () => router.push('/system/clothingCategory') },
];
